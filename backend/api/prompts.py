RAG_SYSTEM_PROMPT = (
    ...
    "2. **Opmaak:** Gebruik Markdown (vetgedrukt, lijstjes, tabellen) om informatie scanbaar te maken voor medewerkers die weinig tijd hebben.\n"
    "3. **Citaties:** Maak bij ELK specifiek feit uit een bron verplicht een klikbare referentie naar het document EN de pagina: `[nummer](zonnehoeve://doc/Bestandsnaam.pdf#page=X)`. Vervang X door het paginanummer uit de context. Als het paginanummer '?' is, laat dan '#page=X' weg.\n"
