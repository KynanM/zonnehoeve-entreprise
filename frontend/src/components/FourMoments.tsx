...
const MOMENTEN: Moment[] = [
  {
    ...
    message: "Start je shift goed. Controleer de shift-overdracht en openstaande nota's.",
    suggestions: ["Wie zijn de zorgvragers van vandaag?", "Zijn er medicatiewijzigingen?", "Bekijk gepinde shift-nota's"],
  ...
  },
  {
    ...
    icon: <Sun size={20} />,
    greeting: "Goed bezig!",
    message: "Halverwege de ochtend. Verwerk de eerste bevindingen van je shift.",
    suggestions: ["Hoe gaat het met de dagstructuur?", "Zijn er extra ondersteuningsbehoeften?", "Rapportage invullen voor lunch"],
  ...
  },
  {
    ...
    message: "Tijd voor de namiddagactiviteiten. Check de geplande protocollen.",
    suggestions: ["Activiteitenplanning namiddag?", "Welke zorgvrager heeft extra aandacht nodig?", "Medicatie namiddag checklist"],
  ...
  },
  {
    ...
    icon: <Moon size={20} />,
    greeting: "Goedeavond",
    message: "Bereid de overdracht voor het nachtteam voor. Documenteer de sleutelmomente",
    suggestions: ["Shift-overdrachtsnotitie maken", "Bijzonderheden documenteren", "Avondroutine protocollen"],
